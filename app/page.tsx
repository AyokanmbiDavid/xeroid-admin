...
export default function Page () {
   return (
    <div className="h-full overflow-y-auto w-full p-4 pb-40">
      <div className="w-full  p-10 rounded-3xl bg-[#d1e4ff] dark:bg-[#405a7e]">
        ...
        <div className="w-full text-[70px] max-md:text-[40px] dark:text-white font-extrabold mt-4">
          Build <span className="text-[#005fa3] dark:text-[#093453]">Intelligence</span> with Xeroid 
        </div>
        <div className="w-full text-[30px] dark:text-gray-300 max-md:text-[20px] text-gray-700 font-extrabold mt-4">
          Together let make something <span className="text-[#005fa3] dark:text-[#093453]">Impossible</span>
        </div>
